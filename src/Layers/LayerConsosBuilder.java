 ...
 */
public class LayerConsosBuilder extends Layer {

         private float consSize_x;
         private float consSize_y;


         public LayerConsosBuilder( String name, float pos_x, float pos_y, float size_x, float size_y,float consSize_x, float consSize_y) {
